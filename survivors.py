...
#Primaries
#Burst assumes all 5 bullets hit in all 4 shots 
...
#Specials
#Beacon Time Approximated to completing a stage every 8 minutes
...
#Doesn't account for hitting multiple enemies
...
#Primary
#Attack Speed Approximated, should be checked and verified, likely wrong
#ASSUMPTION - Assumes only the explosion damage, not the intial hit damage
heretic_hungering_gaze = Ability(heretic, "Hungering Gaze", 1.0, (2/12), 1.2)
#Secondary
#Come back to update initial vs explosion
